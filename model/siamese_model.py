...
from model.cnn_choi import CNN_Choi_Slim, CNN_Choi, RCNN_Choi
...
class SiameseModelRNN(nn.Module):
    def __init__(self, batch_size=64, type='resnet'):
    ...
    def forward_once(self, input):
        ...
        if self.type == 'resnet':
            ...
            cnn_input, h0 = input
            return self.normal(self.backbone(cnn_input))
...
if __name__ == '__main__':
    model = SiameseModelRNN(batch_size=1,type= 'choi')
